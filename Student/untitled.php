...
mysql_select_db("health_centre",$connect); //select the table 

$sql="select * from appscheduler_bookings where student_id='".$_SESSION['ID']."' AND appointment_d <'".date("Y-m-d")."' ORDER BY appointment_d DESC";
//echo $sql;
